        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="https://www.instagram.com/sparkling_kidsparty/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 text-mutedText hover:text-primary transition-colors font-body text-sm"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
